...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Courier New', monospace; user-select: none; }
        ...
        .dt-node-3 { position: absolute; top: 40px; left: 350px; white-space: nowrap; z-index: 10; }
        .dt-node-4 { position: absolute; top: 120px; left: 335px; white-space: nowrap; z-index: 10; }
...
<body onclick="engageContinuousVoice()">
    ...
    <div class="desktop-layout">
        ...
        <div class="hud-glass desktop-bottom-bar">
            <div class="status-headline" id="desktopStatus"></div>
            <div class="input-row">
...
window.addEventListener("load", () => {
    try {
        ...
        if (typeof initHoloSphere === "function") initHoloSphere();
